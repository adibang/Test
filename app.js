...
async function loadAndRenderBundles() {
    ...
    try {
        ...
        if (activeBundles.length === 0) {
            container.innerHTML = '<div style="text-align:center; padding:20px;">Tidak ada bundle aktif. <br><button class="form-button-primary" onclick="window.open(\'master-data.html\', \'_blank\')" >Buat Bundle</button></div>';
            return;
        }
